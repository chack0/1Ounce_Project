...
class _MyHomePageState extends State<MyHomePage> {
  ...
  double gold916Value; //For rounding up the counter decimal values and displaying on the circle's center 
  double gold999Value; //For rounding up the counter decimal values and displaying on the circle's center
  double silverValue;  // ""
                  ...
                  children: <Widget>[
                    RaisedButton(
                      onPressed: () {
                        ...
                        // Navigator.push(
                        //     context, MaterialPageRoute(builder: (context) => StoreList()));
                      },
                      child: Padding(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            //   child: ImageIcon(
                            //     AssetImage('assets/Icons/pickup.png'),
                            //     color: Colors.blue,
                            //   ),
                            // ),
                            Text(
...
//THE BELOW CODE IS THE OLD VERSION,JUST IGNORE IT.
